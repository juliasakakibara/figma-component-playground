import svgPaths from "./svg-9lsbfow1y1";
...
function TextBox() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[16px] items-start not-italic px-0 py-[40px] relative shrink-0 text-[#f6f6f6] w-full" data-name="text-box">
      <p className="font-['Inter:Semi_Bold',_sans-serif] font-semibold leading-[1.2] min-w-full relative shrink-0 text-[36px] tracking-[-0.072px] w-[min-content]">Component Playground</p>
...
function Content() {
  return (
    <div className="bg-[#001aff] relative shrink-0 w-full" data-name="Content">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col items-start justify-center px-[80px] py-0 relative w-full">
          <TextBox />
        </div>
      </div>
    </div>
...
function Content1() {
  return (
    <div className="h-[681px] relative shrink-0 w-full" data-name="Content">
      <div className="flex flex-col items-center size-full">
        <div className="box-border content-stretch flex flex-col h-[681px] items-center p-[80px] relative w-full">
          <Canva />
        </div>
      </div>
    </div>
