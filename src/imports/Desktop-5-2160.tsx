import svgPaths from "./svg-9lre9u87on";
...
function Controlers1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative self-stretch shrink-0 w-[328px]" data-name="Controlers">
      <Card />
      <Controlers />
    </div>
  );
...
function Canva() {
  return (
    <div className="box-border content-stretch flex gap-[16px] items-start px-0 py-[80px] relative shrink-0 w-full" data-name="canva">
      <Controlers1 />
      <Card1 />
    </div>
  );
